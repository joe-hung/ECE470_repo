...
def move_block(pub_cmd, loop_rate, start_xw_yw_zw, target_xw_yw_zw, vel, accel):
    ...
    start_angles_hover = lab_invk(start_xw_yw_zw[0], start_xw_yw_zw[1], start_xw_yw_zw[2]+0.2, 0)

    target_angles_hover = lab_invk(target_xw_yw_zw[0], target_xw_yw_zw[1], target_xw_yw_zw[2]+0.2, 0)
    ...
    if(analog_in_0 < 1.8):
        ...
        sys.exit()
    error = move_arm(pub_cmd,loop_rate,start_angles_hover,vel,accel)
    error = move_arm(pub_cmd,loop_rate,target_angles_hover,vel,accel)
